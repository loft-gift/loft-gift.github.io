...
class TG {
    ...
    public $token = '886329664:AAEW_zt6mgSZ8gq6SJfEQmgki6KnbHs6-Lw'; //Создаём публичную переменную для токена, который нужно отправлять каждый раз при использовании апи тг
